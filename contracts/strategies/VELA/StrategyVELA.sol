...
//import "../../interfaces/vela/IVELARouter.sol";
//import "../../interfaces/vela/IVELATracker.sol";
//import "../../interfaces/vela/IVELAStrategy.sol";
//import "../Common/StratFeeManager.sol";
//import "../../utils/GasFeeThrottler.sol";
//import "../../interfaces/common/IUniswapRouterV3.sol";
//
//contract StrategyVELA is StrategyManager, GasFeeThrottler {
//    using SafeERC20 for IERC20;
//    uint immutable pid = 1;
//
...
//        chef = _chef;
//        rewardStorage = IVELARouter(chef).feeVelaTracker();
//        balanceTracker = IVELARouter(chef).stakedVelaTracker();
...
//
//        if (wantTokenBal > 0) {
//            IVELARouter(chef).deposit(pid, wantTokenBal);
...
//            IVELARouter(chef).unstakeVela(_amount - wantTokenBal);
...
//        IVELARouter(chef).compound();
//        // Claim and re-stake esVELA and multiplier points
//        IVELATracker(rewardStorage).claim(address(this));
...
//        return IVELATracker(balanceTracker).depositBalances(address(this), wantToken);
//    }
//
//    // returns rewards unharvested
//    function rewardsAvailable() public view returns (uint256) {
//        return IVELATracker(rewardStorage).claimable(address(this));
//    }
//
...
//        stop();
//        IVELARouter(chef).unstakeVela(balanceOfPool());
//    }
//
