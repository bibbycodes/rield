...
import type {
  IUniswapRouterBNB,
  IUniswapRouterBNBInterface,
} from "../../../../contracts/interfaces/common/IUniswapRouterBNB";
...
export class IUniswapRouterBNB__factory {
  static readonly abi = _abi;
  static createInterface(): IUniswapRouterBNBInterface {
    return new utils.Interface(_abi) as IUniswapRouterBNBInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IUniswapRouterBNB {
    return new Contract(address, _abi, signerOrProvider) as IUniswapRouterBNB;
  }
}
