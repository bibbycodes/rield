...
export interface BeefyETHVaultInterface extends utils.Interface {
  functions: {
...
export interface BeefyETHVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BeefyETHVaultInterface;
