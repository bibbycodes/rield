...
export interface CapSingleStakeVaultInterface extends utils.Interface {
  functions: {
...
export interface CapSingleStakeVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CapSingleStakeVaultInterface;
