...
export interface CapSingleStakeStratInterface extends utils.Interface {
  functions: {
...
export interface CapSingleStakeStrat extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CapSingleStakeStratInterface;
