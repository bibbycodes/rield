...
export interface StrategyGMXUniV3Interface extends utils.Interface {
  functions: {
    ...
    "nativeToWantPath()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "nativeToWantPath",
    values?: undefined
  ): string;
...
export interface StrategyGMXUniV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StrategyGMXUniV3Interface;
  ...
  functions: {
    ...
    nativeToWantPath(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    nativeToWantPath(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nativeToWantPath(overrides?: CallOverrides): Promise<PopulatedTransaction>;
