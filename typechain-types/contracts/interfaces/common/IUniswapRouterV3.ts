...
export interface IUniswapRouterV3Interface extends utils.Interface {
  functions: {
...
export interface IUniswapRouterV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUniswapRouterV3Interface;
