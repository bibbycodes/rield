...
export interface IUniswapRouterBNBInterface extends utils.Interface {
  functions: {
...
export interface IUniswapRouterBNB extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUniswapRouterBNBInterface;
