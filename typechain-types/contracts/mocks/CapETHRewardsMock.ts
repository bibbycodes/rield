...
export interface CapETHRewardsMockInterface extends utils.Interface {
  functions: {
...
export interface CapETHRewardsMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CapETHRewardsMockInterface;
