...
export interface GasFeeThrottlerInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "gasprice" | "shouldGasThrottle"
  ): FunctionFragment;
...
export interface GasFeeThrottler extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasFeeThrottlerInterface;
